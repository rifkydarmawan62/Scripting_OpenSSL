...
from modul import bersihkan_layar, input_kata_sandi_untuk, input_digest, input_indeks_g, hapus_file_sementara
...
try:
    ...
    try:
        ...
        if file_output:
            ...
            perintah_tambahan, file_sementara = input_kata_sandi_untuk("parameter DSA")
